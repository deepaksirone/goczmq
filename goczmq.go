...
/*
#cgo !windows LDFLAGS: -static -static-libgcc -static-libstdc++ -L/data/projects/phd_stuff/courses/adv_os/project/glibc-2.28/build -L/usr/local/lib -L/usr/lib64/  -l:libczmq.a -l:libzmq.a -l:libsodium.a -l:libstdc++.a
