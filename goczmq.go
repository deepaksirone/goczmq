...
/*
#cgo !windows LDFLAGS: -L/data/projects/phd_stuff/courses/adv_os/project/glibc-2.30/build -l:libc.a -L/usr/local/lib -L/usr/lib64/ -l:libczmq.a -l:libzmq.a -l:libsodium.a -l:libstdc++.a
