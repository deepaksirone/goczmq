...
/*
#cgo !windows LDFLAGS: -static -static-libstdc++ -static-libgcc -L/usr/local/lib -L/usr/lib64/ -l:libczmq.a -l:libzmq.a -l:libsodium.a -l:libstdc++.a -l:libc.a
#cgo !windows CFLAGS: -static -static-libstdc++ -static-libgcc
